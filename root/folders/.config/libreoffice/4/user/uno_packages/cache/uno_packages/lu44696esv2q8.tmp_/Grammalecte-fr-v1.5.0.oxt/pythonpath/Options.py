...
def loadOptions (sLang):
    ...
    try:
        xNode = helpers.getConfigSetting("/org.openoffice.Lightproof_grammalecte/Leaves", False)
...
def saveOptions (sLang, dOpt):
    ...
    try:
        xNode = helpers.getConfigSetting("/org.openoffice.Lightproof_grammalecte/Leaves", True)
        xChild = xNode.getByName(sLang)
